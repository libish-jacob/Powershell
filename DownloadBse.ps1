...
$ie.visible = $true
$ie.ParsedHtml
$ie.navigate2("https://www.bseindia.com/markets/equity/EQReports/StockPrcHistori.aspx")

"Launching Please wait..."
while ($ie.busy) {Start-Sleep 5}

$loginItemName = GetLoginItemName $ie 'ctl00$ContentPlaceHolder1$smartSearch'
$loginItemName.value = 'SBIN'

$loginItemName = GetLoginItemName $ie 'ctl00$ContentPlaceHolder1$scripname'
$loginItemName.value = 'SBIN'

$loginItemName = GetLoginItemName $ie 'ctl00$ContentPlaceHolder1$txtFromDate'
$loginItemName.value = '07/07/2021'

$loginItemName = GetLoginItemName $ie 'ctl00$ContentPlaceHolder1$txtToDate'
$loginItemName.value = '07/08/2021'
